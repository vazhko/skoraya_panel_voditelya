...
BYTE _text_output_char(BYTE x, BYTE idx, const BYTE* pgmFont, BYTE fontFlags, BYTE fontStart, BYTE fontMax, BYTE xorMask){
    const BYTE p;
    WORD fw;
    BYTE w;
